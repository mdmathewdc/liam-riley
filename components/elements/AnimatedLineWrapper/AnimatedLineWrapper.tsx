				...
				{randomIndex === 1 && (
					...
					>
						<motion.path
							...
							animate={isHovered ? { pathLength: 1, opacity: 1 } : isAnimated ? { pathLength: 1, opacity: 0 } : { pathLength: 0, opacity: 0 }}
							transition={{
								pathLength: { 
									duration: 0.5,
									type: "spring",
							...
							strokeDasharray="0 1"
							d="M2 3C105.941 3 209.882 3 313.823 3C321.881 3 329.767 2 338 2"
							stroke="black"
				...
				{randomIndex === 2 && (
					...
					>
						<motion.path
							...
							d="M1.85107 6.13112C23.6843 6.13112 45.5174 6.13112 67.3506 6.13112C76.7371 6.13112 86.063 7.12521 95.4337 7.12521C107.492 7.12521 119.55 7.12521 131.608 7.12521C172.339 7.12521 213.021 8.1193 253.743 8.1193C263.354 8.1193 272.966 8.61635 282.599 8.61635C293.54 8.61635 304.077 7.21966 314.962 6.13112C316.911 5.93621 318.478 5.23311 320.457 5.10942C322.625 4.97394 324.903 4.67866 327.029 4.25339C329.152 3.82895 330.943 3.62471 332.883 2.76226C334.768 1.92481 340.891 2.26484 341.83 4.14294"
							stroke="black"
							strokeWidth={strokeWidth}
							strokeLinecap="round"
						/>
				...
				{randomIndex === 3 && (
					...
					>
						<motion.path
							...
							d="M1.7981 1.9541C66.8926 1.9541 131.987 1.9541 197.082 1.9541C222.739 1.9541 248.254 3.94228 273.903 3.94228C294.705 3.94228 315.507 3.94228 336.31 3.94228"
							stroke="black"
							strokeWidth={strokeWidth}
							strokeLinecap="round"
						/>
